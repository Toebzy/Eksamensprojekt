...
public class BeamGenerator {
    ...
    private final Geometry3D beams;
    ...
    private Geometry3D createBeam() {
        ...
        return csg.translate3DZ(height-59).transform(csg.translate3DY(length/2.0).transform(csg.translate3DX(-width/2.0).transform(csg.union3D(Beam,Beam2))));
    }
